...
function Hero() {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-r from-slate-950 via-slate-900 to-cyan-950 text-white flex items-center">
      <div className="max-w-7xl mx-auto px-8 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          <h1 className="text-6xl md:text-7xl font-extrabold leading-tight">
            ...
            <br />
            <span className="text-cyan-400">AI Interview Agent</span>
          </h1>

          <p className="mt-8 text-xl text-gray-300 leading-8">
            Conduct adaptive AI-powered technical interviews, evaluate
            candidates intelligently, and generate instant technical reports.
          </p>
          ...
          <div className="mt-10 flex gap-6">
            ...
            <button
              className="px-8 py-4 rounded-xl border border-cyan-500 hover:bg-cyan-500 transition"
            >
              View Demo
            </button>
          ...
          <div className="flex gap-12 mt-14">
            ...
            <div>
              <h2 className="text-4xl font-bold text-cyan-400">31</h2>
        ...
        <div className="flex justify-center">
          <div className="bg-slate-800 rounded-3xl p-10 border border-slate-700 shadow-2xl w-full max-w-lg">
            ...
            <div className="flex justify-between items-center">
              <h2 className="text-3xl font-bold">Live Interview</h2>

              <div className="w-4 h-4 rounded-full bg-green-500 animate-pulse"></div>
            </div>

            <p className="text-gray-400 mt-8">Question 3 / 8</p>
            ...
            <p className="mt-10 text-lg text-gray-300 leading-8">
              Explain Retrieval-Augmented Generation and where vector
              databases fit into the pipeline.
            </p>
